...
(
SynthDef.new('pluck', {arg coef=0.1, decay=3, vol=0.5;
	...
	p0 = AllpassN.ar(p0, delays[0], delays[0], 0);
	p1 = AllpassN.ar(p1, delays[1], delays[1], 0);
	p2 = AllpassN.ar(p2, delays[2], delays[2], 0);
	sig = p0 + p1 + p2;
	sig = sig * vol;
